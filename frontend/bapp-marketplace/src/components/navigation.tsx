...
export default function Navigation({
  ...
  return (
    ...
    <div className="max-lg:hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              ...
              <div className="flex items-center justify-end ">
                ...
                <Menu as="div" className="relative ml-5 flex-shrink-0 ">
                  <div>
                    {isAuthenticated ? (
                      <Menu.Button className="relative flex rounded-full bg-indigo-600 p-3 text-white font-bold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        <span className="absolute -inset-1.5" />
                        <span className="sr-only">Open user menu</span>
                        <div>{shortenPrincipalName(principal.toText())}</div>
